...
import com.android.settings.infamous.AnimBarPreference;
...
public class AnimationControls extends SettingsPreferenceFragment implements OnPreferenceChangeListener {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        setTitle(R.string.infamous_animation_title);
        // Load the preferences from an XML resource
        addPreferencesFromResource(R.xml.infamous_animation_controls);
